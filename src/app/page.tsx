...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'contact.locationValue': 'Manakkadavu, Munroe Island, Kerala 691502',
    'contact.phoneValue': '+91 474 XXXXXXX\n+91 XXXXX XXXXX (WhatsApp)',
    'contact.emailValue': 'munroemorrisklm@gmail.com',
  ...
  ml: {
    ...
    'contact.locationValue': 'മണക്കടവ്, മുൻറോ ദ്വീപ്, കേരളം 691502',
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-4 pt-2">
              <a href="https://maps.app.goo.gl/x9yYME3FYTTjk3Wy7" target="_blank" rel="noopener noreferrer" className="skeuo-inset p-2 rounded-lg hover:bg-primary/20 transition-colors" title="Google Maps">
                <MapPin className="h-5 w-5 text-primary" />
              </a>
              <a href="https://www.instagram.com/munroemorrisservicevilla/" target="_blank" rel="noopener noreferrer" className="skeuo-inset p-2 rounded-lg hover:bg-primary/20 transition-colors" title="Instagram">
                <Instagram className="h-5 w-5 text-primary" />
              </a>
              <a href="https://www.facebook.com/munroemorrisservicevilla" target="_blank" rel="noopener noreferrer" className="skeuo-inset p-2 rounded-lg hover:bg-primary/20 transition-colors" title="Facebook">
                <Facebook className="h-5 w-5 text-primary" />
              </a>
              <a href="https://www.youtube.com/@MunroeMorrisVilla" target="_blank" rel="noopener noreferrer" className="skeuo-inset p-2 rounded-lg hover:bg-primary/20 transition-colors" title="YouTube">

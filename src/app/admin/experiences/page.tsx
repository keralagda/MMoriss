...
const mockExperiences: Experience[] = [
  { id: '1', name: 'Houseboat Cruise', description: 'Drift through the enchanting backwaters on a traditional Kettuvallam houseboat', duration: 'Full Day / Overnight', price: 25000, priceType: 'per_couple', highlights: ['Private chef', 'Sunset views', 'Village life', 'Traditional cuisine'], images: ['/images/experience-1.png'], active: true, featured: true, sortOrder: 1 },
  { id: '2', name: 'Ayurveda Wellness', description: 'Rejuvenate with authentic Ayurvedic treatments and therapies', duration: '1-21 Days Programs', price: 5000, priceType: 'per_session', highlights: ['Certified practitioners', 'Traditional herbs', 'Holistic healing', 'Custom programs'], images: ['/images/spa.png'], active: true, featured: true, sortOrder: 2 },
  { id: '3', name: 'Village Life Experience', description: "Immerse yourself in Kerala's rich culture and traditions", duration: 'Half Day', price: 2500, priceType: 'per_person', highlights: ['Coir making', 'Fishing demo', 'Paddy fields', 'Local artisans'], images: ['/images/indoor-activity.jpg'], active: true, featured: false, sortOrder: 3 },
  { id: '4', name: 'Kathakali Performance', description: "Witness the ancient art form of Kerala's classical dance-drama", duration: '2-3 Hours', price: 1500, priceType: 'per_person', highlights: ['Traditional makeup', 'Classical music', 'Epic stories', 'Photo opportunity'], images: ['/images/gallery-2.png'], active: true, featured: false, sortOrder: 4 },
  { id: '5', name: 'Sunset Canoe Ride', description: 'Paddle through narrow canals as the sun sets over the backwaters', duration: '2 Hours', price: 1000, priceType: 'per_person', highlights: ['Narrow canals', 'Sunset views', 'Bird watching', 'Village glimpses'], images: ['/images/gallery-5.png'], active: true, featured: false, sortOrder: 5 },
  { id: '6', name: 'Spice Plantation Tour', description: 'Explore the aromatic spice gardens of the Western Ghats', duration: 'Full Day', price: 3500, priceType: 'per_person', highlights: ['Cardamom fields', 'Pepper vines', 'Traditional lunch', 'Spice shopping'], images: ['/images/gallery-6.png'], active: true, featured: false, sortOrder: 6 },
  { id: '7', name: 'Kerala Cooking Class', description: 'Learn to prepare authentic Kerala dishes with our master chefs', duration: '3 Hours', price: 2000, priceType: 'per_person', highlights: ['Fresh spices', 'Seafood prep', 'Recipe booklet', 'Meal included'], images: ['/images/gallery-1.png'], active: true, featured: true, sortOrder: 7 },
  { id: '8', name: 'Yoga & Meditation', description: 'Find inner peace with traditional yoga and meditation sessions', duration: '1-2 Hours', price: 0, priceType: 'complimentary', highlights: ['Hatha yoga', 'Pranayama', 'Backwater views', 'All levels welcome'], images: ['/images/spa.png'], active: true, featured: false, sortOrder: 8 },
]

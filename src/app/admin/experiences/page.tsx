...
const mockExperiences: Experience[] = [
  ...
  { id: '3', name: 'Village Life Experience', description: "Immerse yourself in Kerala's rich culture and traditions", duration: 'Half Day', price: 2500, priceType: 'per_person', highlights: ['Coir making', 'Fishing demo', 'Paddy fields', 'Local artisans'], images: ['/images/experience-3.png'], active: true, featured: false, sortOrder: 3 },

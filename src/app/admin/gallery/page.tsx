...
const mockImages: GalleryImage[] = [
  { id: '1', title: 'Sunrise over the Backwaters', description: 'The golden hour paints the waters in magical hues', category: 'backwaters', imageUrl: '/images/hero.png', featured: true, active: true, sortOrder: 1 },
  { id: '2', title: 'Heritage Villa', description: 'Traditional Kerala architecture meets modern comfort', category: 'resort', imageUrl: '/images/gallery-1.png', featured: false, active: true, sortOrder: 2 },
  ...
  { id: '4', title: 'Pool Villa', description: 'Private plunge pool with garden views', category: 'resort', imageUrl: '/images/gallery-3.png', featured: false, active: true, sortOrder: 4 },
  { id: '5', title: 'Ayurveda Treatment', description: 'Authentic healing therapies', category: 'wellness', imageUrl: '/images/gallery-4.png', featured: false, active: true, sortOrder: 5 },
  ...
  { id: '8', title: 'Backwater Villa', description: 'Serene views from your room', category: 'resort', imageUrl: '/images/villa-1.png', featured: false, active: true, sortOrder: 8 },
  { id: '9', title: 'Coconut Grove Suite', description: 'Amongst the coconut palms', category: 'resort', imageUrl: '/images/villa-2.png', featured: false, active: true, sortOrder: 9 },
  { id: '10', title: 'Heritage Nalukettu', description: 'Traditional courtyard house', category: 'resort', imageUrl: '/images/villa-3.png', featured: false, active: true, sortOrder: 10 },
  ...
  { id: '12', title: 'Village Tour', description: 'Experiencing local life', category: 'culture', imageUrl: '/images/experience-3.png', featured: false, active: true, sortOrder: 12 },

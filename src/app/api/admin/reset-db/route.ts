...
const DEFAULT_ROOMS = [
  ...
  },
  {
    ...
    features: JSON.stringify(['Private Chef', 'Butler Service', '360° View', 'Sun Deck']),
    amenities: JSON.stringify(['WiFi', 'Air Conditioning', 'Mini Bar', 'In-room Safe', 'Smart TV', 'Private Dining']),
